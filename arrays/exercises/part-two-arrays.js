...
console.log(`affter poping: ${cargoHold.pop()}, cargoHold Become: ` );
console.log(cargoHold);
//3) Remove the first item from the array with shift. Print the element removed and the updated array.
console.log(`affter shifting: ${cargoHold.shift()}, cargoHold Become: ` );
console.log(cargoHold);
...
console.log(`affter unshifting: 1138, cargoHold Become: ` );
console.log(cargoHold);

cargoHold.push("20 meters");
console.log(`affter pushing: 20 meters, cargoHold Become: ` );
console.log(cargoHold);
//5) Use a template literal to print the final array and its length.

console.log(`the finale array is:[ ${cargoHold}], \n  it's length is ${cargoHold.length}` );